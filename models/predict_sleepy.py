...
# === Cấu hình ===
MODEL_PATH = "sleepy_model_mobilenetv2.h5"
LABELS_PATH = "sleepy_labels.json"
TEST_FOLDER = "D:/KLTN/AI/models/dataset_sleepy_processed/normal"  # 👈 sửa theo folder cần test
